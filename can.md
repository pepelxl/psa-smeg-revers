...
D0[7]-D1[0] установленная скорость, по умолчанию 0xFF 0xFF. Например D0=0x13 D1=88 в десятичной системе= 5000 = будет отображать 50км/ч  
D2[7] LIMIT - отобращение режима  
D2[6] CRUISE - отображение режима  
D2[5]  
D2[4]  
D2[3] LIMIT/CRUISE активен  
D2[2]  
D2[1]  
D2[0] бит установлен, когда идет изменение заданной скорости, например от кнопок +/- руля  
D3[7]  
D3[6]  
D3[5]  
D3[4]  
...
D3[1]  
D3[0]  
D4[7] CRUISE - запрос на внесение скорости из памяти. На SMEG появляется вкладка  с выбором 6 
 предустановленных скоростей. Не путать с 5 предустановленными скоростями, которые хранятся в BSI.  
D4[6] LIMIT - запрос на внесение скорости из памяти. На SMEG появляется вкладка  с выбором 6 
 предустановленных скоростей. Не путать с 5 предустановленными скоростями, которые хранятся в BSI.  
