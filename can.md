...
Пакет вещает текущие значения круиз контроля  
D0[7]-D1[0] установленная скорость(0-260км/ч), по умолчанию 0xFF 0xFF. Например D0=0x13 D1=88 в десятичной системе= 5000 = будет отображать 50км/ч. Глядя на байты D5-D6, возможно старший бит имеет другое назначение.  
D2[7] LIMIT - отобращение режима  
D2[6] CRUISE - отображение режима  
D2[5]  
D2[4]  
D2[3]    
D2[2]  
D2[1]  
D2[0] бит установлен, когда идет изменение заданной скорости, например от кнопок +/- руля, но бит не устанавливается при задании скорости после клавиши MEM  
D3[6]  
D3[5]  
D3[4]  
D3[3]  
...
D5[7]  
D5[6]-D6[0] отрегулированная скорость системами активного круиз-контроля  
D7[7]   
D7[6]  
D7[5]  
D7[4] бит установлен при выключенном в меню активном круиз-контроле(RVVI). Вместе с битом D7[7]. D7=0x90  
D7[3]  
D7[2]  
D7[1]  
D7[0]  
