...
### ID 0x350, источник BSI, длина 7, частота 500мс  
Пакет вещает состояние переднего климат контроля.  
Надо понимать, что алгоритм управления климатконтролем находится в BSI. Блок климата является исполнительным устройством, получая от BSI информацию о прцентном положении приводов заслонок.  
BSI получает действия пользователя, или от ГУ по ID 0x364, или от передней панели климата.  
Пример: 02  FF  FF  4D  0D  80  04  
D0[7]  
D0[6]  
D0[5] Индикация подогрева заднего стекла. Появляется один раз при нажатии на кнопку.  
D0[4]  
...
### ID 0x3D0, источник BSI, длина 5, частота 500мс  
Пакет вещает состояние заднего климат контроля.  
