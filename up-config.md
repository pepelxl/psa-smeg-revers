...
| diag | Vin_crypted | BLOB |Ячейка содержит закриптованное 17-значное vin номера атомобиля. Вместе с ячейками supervisor служит для идентификации автомобиля. Если хранимый vin не совподает с vin записанным в bsi, срабатывает зашита(писк в динамики)|
